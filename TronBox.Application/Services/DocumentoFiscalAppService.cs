    ...
    public class DocumentoFiscalAppService : IDocumentoFiscalAppService
    {
        ...
        private DocumentoFiscalDTO ObterConhecimentoTransporteFromObject(string inscricaoEmpresa, bool salvarCteEntrada, bool salvarCteSaida, bool salvarCteNaoTomador, cteProc cte)
        {
            var documentoFiscal = new DocumentoFiscalDTO()
            {
                ...
                DataEmissaoDocumento = UtilitarioDatas.ConvertToIntDate(cte.CTe.infCte.ide.dhEmi.DateTime),
        ...
        private DocumentoFiscalDTO ObterNotaFiscalFromObject(string inscricaoEmpresa, nfeProc nfe)
        {
            var documentoFiscal = new DocumentoFiscalDTO()
            {
                ...
                ? UtilitarioDatas.ConvertToIntDate(nfe.NFe.infNFe.ide.dhEmi.DateTime) : UtilitarioDatas.ConvertToIntDate(nfe.NFe.infNFe.ide.dEmi),
