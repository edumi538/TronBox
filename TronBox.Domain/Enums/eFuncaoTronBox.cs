...
namespace TronBox.Domain.Enums
{
    public class eFuncaoTronBox : eFuncao
    {
        ...
        public static eFuncao DocumentoFiscal { get { return new eFuncao(Guid.Parse(ID_DOCUMENTO_FISCAL), "Consulta Documentos", Modulo.Box, "/documentos-fiscais", "file-code-o", eTipoFuncao.ROTA_MENU, 2); } }
        public static eFuncao Upload { get { return new eFuncao(Guid.Parse(ID_UPLOAD), "Enviar Documentos", Modulo.Box, "/enviar-documentos", "cloud-upload", eTipoFuncao.ROTA_MENU, 3); } }
        public static eFuncao Manifesto { get { return new eFuncao(Guid.Parse(ID_MANIFESTO), "Manifesto", Modulo.Box, "/manifestos", "file-text", eTipoFuncao.ROTA_MENU, 4); } }
